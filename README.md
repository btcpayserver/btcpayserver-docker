...
* `BTCPAY_CHEATMODE`: When `NBITCOIN_NETWORK=regtest` is used, you can enable Cheat Mode which allows you to fake Bitcoin payments directly on the payment page. Use this for easier testing. Set the value to `true` or `false`. Default: `false`
