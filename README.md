...
* [opt-add-portainer](docker-compose-generator/docker-fragments/opt-add-portainer.yml), to add Portainer, a lightweight Docker management UI. Becomes available at `/portainer`. WARNING: REGISTER AN ACCOUNT AS SOON AS YOU ENABLE IT AS IT GIVES YOU ADMIN ACCESS.
