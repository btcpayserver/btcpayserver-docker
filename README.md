...
* [opt-btc-datacarriersize.yml](docker-compose-generator/docker-fragments/opt-btc-datacarriersize.yml) to set the datacarrier size parameter to 83 byte, same as the default OP_RETURN size for Bitcoin Core, and filter extra data out of the node's mempool.
