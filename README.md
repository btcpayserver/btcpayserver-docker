...
* [opt-expose-rpc](docker-compose-generator/docker-fragments/opt-expose-rpc.yml), to unsafely expose bitcoind RPC port 8332 if you require RPC access for testing applications not yet integrated into BTCPayServer. WARNING: ONLY USE ON TRUSTED LAN OR WITH FIREWALL RULES WHITELISTING SPECIFIC HOSTS. This is even more unsafe than opt-expose-unsafe!
