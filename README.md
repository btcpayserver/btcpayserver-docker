...
First, make sure you have a domain name pointing to your host (CNAME), with ports `443` and `80` externally accessible (and perhaps additional ports like `9735` for Lightning Network (`9736` if you use Litecoin Lightning). Otherwise, you will have to set it manually by running `changedomain.sh`.
