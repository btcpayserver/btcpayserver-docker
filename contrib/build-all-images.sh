...
# Build lightning
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v0.7.0/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v0.7.0/contrib/linuxarm32v7.Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="contrib/linuxarm32v7.Dockerfile"
echo "Building btcpayserver/lightning:v0.7.0"
git clone https://github.com/btcpayserver/lightning lightning
cd lightning
git checkout basedon-v0.7.0
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/lightning:v0.7.0" .
cd - && cd ..
