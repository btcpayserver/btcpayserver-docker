...
# Build cloudflared
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Cloudflared/2024.8.2-1/Cloudflared/2024.8.2/Dockerfile
...
echo "Building btcpayserver/cloudflared:2024.8.2-1"
git clone https://github.com/btcpayserver/dockerfile-deps cloudflared
cd cloudflared
git checkout Cloudflared/2024.8.2-1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/cloudflared:2024.8.2-1" .
cd - && cd ..
