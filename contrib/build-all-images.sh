...
# Build monero
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Monero/0.18.4.0-2/Monero/0.18.4.0/Dockerfile
DOCKERFILE="Monero/0.18.4.0/Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Monero/0.18.4.0-2/Monero/0.18.4.0/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Monero/0.18.4.0/Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Monero/0.18.4.0-2/Monero/0.18.4.0/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Monero/0.18.4.0/Dockerfile"
echo "Building btcpayserver/monero:0.18.4.0-2"
git clone https://github.com/btcpayserver/dockerfile-deps monero
cd monero
git checkout Monero/0.18.4.0-2
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/monero:0.18.4.0-2" .
cd - && cd ..
