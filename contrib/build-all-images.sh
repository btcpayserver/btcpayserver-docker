...
# Build lightning
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.7-1/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.7-1/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/lightning/basedon-v26.06.7-1/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building btcpayserver/lightning:v26.06.7-1"
git clone https://github.com/btcpayserver/lightning lightning
cd lightning
git checkout basedon-v26.06.7-1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/lightning:v26.06.7-1" .
cd - && cd ..
...
# Build elements
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Elements/23.3.4/Elements/23.3.4/linuxamd64.Dockerfile
DOCKERFILE="Elements/23.3.4/linuxamd64.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Elements/23.3.4/Elements/23.3.4/linuxarm32v7.Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Elements/23.3.4/linuxarm32v7.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Elements/23.3.4/Elements/23.3.4/linuxarm64v8.Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Elements/23.3.4/linuxarm64v8.Dockerfile"
echo "Building btcpayserver/elements:23.3.4"
git clone https://github.com/btcpayserver/dockerfile-deps elements
cd elements
git checkout Elements/23.3.4
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/elements:23.3.4" .
cd - && cd ..
...
# Build nbxplorer
# https://raw.githubusercontent.com/btcpayserver/nbxplorer/v2.6.17/Dockerfile
DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/nbxplorer/v2.6.17/Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/nbxplorer/v2.6.17/Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Dockerfile"
echo "Building nicolasdorier/nbxplorer:2.6.17"
git clone https://github.com/btcpayserver/nbxplorer nbxplorer
cd nbxplorer
git checkout v2.6.17
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "nicolasdorier/nbxplorer:2.6.17" .
cd - && cd ..
...
# Build tor
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Tor/0.4.9.12-1/Tor/0.4.9.12/linuxamd64.Dockerfile
DOCKERFILE="Tor/0.4.9.12/linuxamd64.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Tor/0.4.9.12-1/Tor/0.4.9.12/linuxarm32v7.Dockerfile
[[ "$(uname -m)" == "armv7l" ]] && DOCKERFILE="Tor/0.4.9.12/linuxarm32v7.Dockerfile"
# https://raw.githubusercontent.com/btcpayserver/dockerfile-deps/Tor/0.4.9.12-1/Tor/0.4.9.12/linuxarm64v8.Dockerfile
[[ "$(uname -m)" == "aarch64" ]] && DOCKERFILE="Tor/0.4.9.12/linuxarm64v8.Dockerfile"
echo "Building btcpayserver/tor:0.4.9.12-1"
git clone https://github.com/btcpayserver/dockerfile-deps tor
cd tor
git checkout Tor/0.4.9.12-1
cd "$(dirname $DOCKERFILE)"
docker build -f "$DOCKERFILE" -t "btcpayserver/tor:0.4.9.12-1" .
cd - && cd ..
