...
| [`opt-add-fireflyiii`](https://github.com/btcpayserver/btcpayserver-docker/blob/master/docker-compose-generator/docker-fragments/opt-add-fireflyiii.yml) | Add Firefly III on a dedicated host; see the [guide](./fireflyiii.md) |
